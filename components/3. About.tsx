      ...
      <div className="font-mono flex flex-col">
        ...
        <p className="mb-3">
          <span className="font:mono font-medium">
            ...
            in <span className="=font-bold">data analysis</span>, <span className="=font-bold">programming</span>, and problem-solving. My passion for technology led me to gain 
